...
// Repo-relative: the workflow runs with the repo root as its working directory.
const PAIRS = '_qa/out/pairs'   // fn_*.txt : each has RAW DISASSEMBLY then `--- DECOMPILED ---` then our C
const ENGINE = 'engine/analysis/decompiler.cpp'
