...
export DLLNAME="$NAME"
cd /c/Users/User/Downloads/sd/_qa/selfdll
PAIRS=/c/Users/User/Downloads/sd/_qa/pairs
EXE=$(ls -t /c/Users/User/Downloads/sd/target/release/deps/dump_pairs-*.exe | head -1)
...
Set-Location "C:\Users\User\Downloads\sd\_qa\selfdll"
$n = $env:DLLNAME
...
# decompile it fresh
rm -f "$PAIRS"/fn_*.txt
DS_REAL_BIN="C:\Users\User\Downloads\sd\_qa\selfdll\\${NAME}.dll" DS_PAIRS_CAP=400 "$EXE" --nocapture >/dev/null 2>&1
